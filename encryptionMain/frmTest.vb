...
Public Class frmTest
    ...
    Private Sub EncryptMessage()
        Try
            Dim EncryptedMessage As encryptionMain.RSAResult = encryptionMain.RSA.Encrypt(txtMessageToEncrypt.Text, txtPublicKey.Text)
            Dim DecryptedMessage As encryptionMain.RSAResult = encryptionMain.RSA.Decrypt(EncryptedMessage.AsBytes, txtPrivateKey.Text)
